...
$(document).ready(function(){
  ...
  var $top_box=$(".top_box");
  var MenuShow=0;
  var top_box_innerHtml = '<header class="header_bar">'+
                            '<a class="mobile_home_icon iconfont" href="/">'+
                              '<i class="fa fa-home iconfont"></i>'+
                            '</a>'+
                            '<a class="mobile_search_icon" href="#">'+
                              '<i class="fa fa-search"></i>'+
                            '</a>'+
                            '<a class="mobile_menu_icon" id="mobile_menu_icon">'+
                              '<i class="open iconfont fa fa-bars "></i>'+
                              '<i class="close iconfont fa fa-chevron-down"></i>'+
                            '</a></header>';
 
  $top_box.prepend(top_box_innerHtml);
...
$(function(){
     var TouchEvent="touchstart";
     if(IsPC()){TouchEvent="click"}    
     var icon='<a class="gotoptop_icon" id="gotoptop_icon" href="javascript:void(0)"><i class="iconfont fa fa-arrow-circle-up"></i></a>';
