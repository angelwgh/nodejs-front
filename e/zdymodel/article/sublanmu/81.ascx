...
<li>
<div class="tw_com ">
<a href="<%=Detail_Url(dr)%>" class="tw_c_tit"><%=SubStr(dr["title"].ToString(),Title_Num,true)%></a>
<div class="tw_c_time"><%=((DateTime)dr["thedate"]).ToString("yyyy-MM-dd")%></div>
<div class="tw_c_jj"><%=SubStr(dr["pa_introduct"].ToString(),200,true)%></div>
</div>
</li>
<%
 }
