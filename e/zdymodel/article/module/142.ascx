...
%>
<li class="wz_li">
<div class="d1"><a href="<%=Detail_Url(dr)%>"><%=dr["title"].ToString()%></a><span><%=SubStr(dr["pa_introduct"].ToString(),100,true)%></span></div>
<div class="d2"><a href="<%=Detail_Url(dr)%>">MORE+</a></div>
</li>
<%
 }
%>
